...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/guzza/ProgressHUD"
  ...
  s.author             = { "Emir Kalauzovic" => "emir@rubicon.ba" }
  # Or just: s.author    = "Emir Kalauzovic"
  # s.authors            = { "Emir Kalauzovic" => "emir@rubicon.ba" }
  # s.social_media_url   = "http://twitter.com/Emir Kalauzovic"
  ...
  s.source       = { :git => "https://github.com/guzza/ProgressHUD", :tag => "1.3.1" }
