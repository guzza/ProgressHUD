...
@synthesize interaction, window, background, hud, spinner, image, label, backgroundColor,labelFont,labelTextColor, spinnerTintColor,cornerRadius,interactionNoBackgroundColor;
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
    ...
    if (hud.superview == nil)
    {
        if (interaction == NO)
        {
            ...
            background.backgroundColor = (self.interactionNoBackgroundColor!=nil)?self.interactionNoBackgroundColor : HUD_WINDOW_COLOR;
    ...
    if (spinner == nil)
    {
        spinner =  [[MRActivityIndicatorView alloc] initWithFrame:CGRectMake(0, 0, 60, 60)];
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
    ...
    if (label.text != nil)
    {
        ...
        hudWidth = labelRect.size.width + 80;
